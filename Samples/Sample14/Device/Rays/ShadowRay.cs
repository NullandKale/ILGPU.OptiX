...
namespace Sample14
{
    ...
    /// explicit rows above instead of relying on an implicit default: omitting the
    /// opaque row would report light as fully visible straight through solid geometry,
    /// and letting __miss__shadow overwrite the seed would discard any
    ...
    public static class ShadowRay
    {
        ...
        // why overwriting the payload here would be wrong.
