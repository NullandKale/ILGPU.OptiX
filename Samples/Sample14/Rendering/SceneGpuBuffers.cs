...
namespace Sample14
{
    ...
    public sealed class SceneGpuBuffers : IDisposable
    {
        ...
        public void Upload(SceneData scene)
        {
            ...
            // through SceneBuilder would otherwise upload a null Tangents pointer
            // against a populated Vertices buffer, an illegal-memory-access crash.
            // Any per-hit orthogonalization quality loss from this fallback is
            // invisible anyway, since it's only reached by scenes with no
            // NormalTexture to begin with.
