...
namespace Sample21
{
    ...
    /// and produces the final <see cref="SceneData"/> via <see cref="Build"/>. Shared
    /// AddQuad/AddTriangle/AddMaterial/AddMesh/... helpers, so scene builders don't
    ...
    public sealed class SceneBuilder
    {
        ...
        // its "vt" case comment). Without this flip, every AddQuad-built vertical
        // surface paints the image's top row at its own bottom edge and vice versa.
        ...
        // Default 128x128 (~32.5k triangles) is intentionally high, for visual
        // quality on hero/showcase spheres (mirror/glass
        ...
        // Y-axis cylinder - smooth-shaded side (per-vertex radial normals) plus
