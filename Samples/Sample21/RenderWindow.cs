        ...
        protected override void OnRenderFrame(FrameEventArgs args)
        {
            ...
            if (frameCount % 120 == 0)
            {
                ...
                Console.WriteLine(
                    ...
                    $"Trace: {stats.TraceMs:0.00}ms Nrc: {stats.NrcMs:0.00}ms Denoise: {stats.DenoiseMs:0.00}ms Tonemap: {stats.TonemapMs:0.00}ms");
            }
        }
