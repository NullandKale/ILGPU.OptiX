...
namespace Sample14
{
    ...
    /// (no custom primitives or volume grid), so no IAS or second GAS is needed.
    /// </summary>
    public sealed class AccelStructureBuilder : IDisposable
    {
        ...
        // after building both; a mismatch would make every triangle silently resolve
        // to hitgroup record 0 regardless of its actual material.
