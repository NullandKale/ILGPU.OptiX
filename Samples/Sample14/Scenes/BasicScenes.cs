...
namespace Sample14
{
    ...
    public static class BasicScenes
    {
        ...
        // conductor gold on the bottom), lit only by point lights - isolates whether
        // the GGX lobe itself is energy-conserving and free of fireflies/NaNs at
        // grazing angles. Each (row, column) material
