...
namespace Sample14
{
    ...
    public sealed class SbtBuilder
    {
        ...
        public void Apply(RayTracingPipeline<LaunchParams> pipeline, SceneData scene, MeshRange[] triangleMeshRanges)
        {
            ...
            // TextureObject=0, meaning "no texture". NormalTexture/OrmTexture follow
            // the exact same resolution as BaseColorTexture - MaterialSbtData.
            // OrmTexture/NormalTexture themselves are never read here; only the
            // parallel *TexturePaths arrays are.
