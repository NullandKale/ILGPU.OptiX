...
namespace Sample15
{
    ...
    /// every OptiX program in this sample. The 21-register payload convention:
    ...
    public static class Payloads
    {
        ...
        internal const int RadiancePayloadCount = 21;
        ...
        internal static void SetContinuePayload(Vec3 contribution, uint flag, Vec3 newOrigin, Vec3 newDir, Vec3 tint, Vec3 normal, Vec3 albedo, uint rngState, float bsdfPdf)
        {
            OptixPayload.Payload0 = Interop.FloatAsInt(contribution.x);
            OptixPayload.Payload1 = Interop.FloatAsInt(contribution.y);
            OptixPayload.Payload2 = Interop.FloatAsInt(contribution.z);
