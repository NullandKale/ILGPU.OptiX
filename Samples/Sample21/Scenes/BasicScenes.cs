...
namespace Sample21
{
    ...
    public static class BasicScenes
    {
        ...
        // Ambient-only lit, single textured quad - uses one texture already bundled
        // for Sponza, rather than fetching a new asset.
        ...
        // conductor gold on the bottom), lit only by point lights (no NEE/env light) -
        // isolates whether the GGX lobe itself is energy-conserving and free of
        // fireflies/NaNs at grazing angles, without NEE+MIS or HDRI lighting in the
        // picture. Each (row, column) material
