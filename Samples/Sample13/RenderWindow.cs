...
namespace Sample13
{
    ...
    public sealed class RenderWindow : GameWindow
    {
        ...
        // Camera/Vec3/CameraMotion types. Mouse delta is computed manually from
        ...
        protected override void OnLoad()
        {
            ...
            // deliberately not enabled - Sample13 only needs one overlay panel, and
