...
namespace Sample13.UI.Backends
{
    internal unsafe static class ImguiImplOpenTK4
    {
        ...
        static void UpdateMouseData()
        {
            ...
            for (int n = 0; n < platformIO.Viewports.Size; n++)
            {
                ...
                // later version) - harmless to skip since Sample13 doesn't enable
        ...
        static void UpdateMouseCursor()
        {
            ...
            // shapes were added in a later OpenTK version than what Sample13
