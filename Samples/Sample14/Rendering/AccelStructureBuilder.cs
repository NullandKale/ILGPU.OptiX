...
namespace Sample14
{
    ...
    public sealed class AccelStructureBuilder : IDisposable
    {
        ...
        // structure and the SBT no longer agree on the hitgroup record layout - see
        // Sample13's identical field for the bug class this guards against.
        ...
        // exact same configured build inputs (same buffer pointers) used at Build() time -
        // see the identical field in Sample13's AccelStructureBuilder.cs. Holds no GPU
        // resources itself (builders are ephemeral per the Phase 1 disposal contract).
