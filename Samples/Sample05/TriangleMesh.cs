...
namespace Sample05
{
    public class TriangleMesh
    {
        ...
        public TriangleMesh(Accelerator accelerator)
        {
            ...
            triangleColorBuffer = new List<Vec3>();
        }

        public void addUnitCube(Vec3 center, Vec3 size, Vec3 color)
        {
            AddCube(new Affine3f(center, size), color);
        }

        public void AddCube(Affine3f xfm, Vec3 color)
        {
            ...
            d_triangleColorBuffer = accelerator.Allocate1D(triangleColorBuffer.ToArray());
        }
    }
}
