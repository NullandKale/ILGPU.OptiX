...
namespace Sample14
{
    ...
    public static class RadianceRay
    {
        ...
        public unsafe static void __closest__radiance(LaunchParams launchParams)
        {
            ...
            // Only the dielectric (transmissive) branch is a threshold cut -
            // Transmission > 0 routes to ShadeDielectric's Fresnel-weighted
            // reflect/refract glass path. Every other material, regardless of
            // Metallic value, goes through the single unified GGX metallic-roughness
            // BSDF in Bsdf.cs/ShadeSurface: Roughness continuously drives mirror-like
            // through fully diffuse-like response, and Metallic continuously blends
            // Lambertian diffuse against Fresnel-tinted GGX specular.
