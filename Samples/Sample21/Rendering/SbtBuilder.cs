...
namespace Sample21
{
    ...
    public sealed class SbtBuilder
    {
        ...
        public void Apply(RayTracingPipeline<LaunchParams> pipeline, SceneData scene, MeshRange[] triangleMeshRanges)
        {
            ...
            // keeps TextureObject=0 ("no texture"). NormalTexture/OrmTexture follow the
            // exact same resolution as BaseColorTexture - MaterialSbtData.OrmTexture/
            // NormalTexture themselves are never read here; only the parallel
            // *TexturePaths arrays are.
