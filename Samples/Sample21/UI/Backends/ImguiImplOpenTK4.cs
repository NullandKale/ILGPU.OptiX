...
namespace Sample21.UI.Backends
{
    internal unsafe static class ImguiImplOpenTK4
    {
        ...
        static void UpdateMouseCursor()
        {
            ...
            // shapes were added in a later OpenTK version than this sample references)
            // - fall back to the closest available shape rather than bumping the whole
            // project's OpenTK version just for cursor icons.
            static MouseCursor GetCursor(ImGuiMouseCursor imguiCursor)
            {
                switch (imguiCursor)
                {
                    ...
                    case ImGuiMouseCursor.ResizeNS:
                        return MouseCursor.VResize;
                    case ImGuiMouseCursor.ResizeEW:
                        return MouseCursor.HResize;
