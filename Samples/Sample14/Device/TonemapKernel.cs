...
namespace Sample14
{
    ...
    ///    HDR to LDR range
    /// 3. sRGB OETF (true piecewise curve, not an approximation) - linear to
    ...
    public static class TonemapKernel
    {
        ...
        // True piecewise sRGB OETF (IEC 61966-2-1) - the linear segment near black
        // matters for shadow-detail banding that a flat gamma curve doesn't reproduce
        // exactly.
