...
namespace Sample21
{
    ...
    public struct LCG
    {
        ...
        // instead of reseeding a fresh TEA hash - reseeding per shading call from
        // (pixel, frame, primitive) silently correlates rays that hit the same
        // primitive on different bounces, which this constructor exists to avoid.
